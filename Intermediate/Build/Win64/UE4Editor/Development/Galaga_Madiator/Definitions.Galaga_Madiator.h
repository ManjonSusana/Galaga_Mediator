...
#define UE_PROJECT_NAME Galaga_Madiator
#define UE_TARGET_NAME Galaga_MadiatorEditor
#define UE_MODULE_NAME "Galaga_Madiator"
...
#define GALAGA_MADIATOR_API DLLEXPORT
