...
AGalaga_MadiatorProjectile::AGalaga_MadiatorProjectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &AGalaga_MadiatorProjectile::OnHit);		// set up a notification for when this component hits something
